...
// const stripePromise = loadStripe("pk_test_51RtMbYPXJmbviv6Lhv2DUHHpyMoTZOBS3gG3gLyTmEB396yw7RPpydIUoWrmIpqQVtuqiEHbZGY2E9b0j5jULe7500MTIQs6Ay");

// // ========================== CARD CHECKOUT ==========================
// const CheckoutForm = ({ product, formDataup, setOrderSuccess }) => {
//   const stripe = useStripe();
//   const elements = useElements();
...
//       if (result.paymentIntent.status === "succeeded") {
//         toast.success("✅ Card Payment successful! Placing order...");
...
// // ========================== UPI CHECKOUT ==========================
// const UpiForm = ({ product, formDataup, setOrderSuccess }) => {
//   const stripe = useStripe();
...
//           type: "upi",
//           upi: {
//             vpa: "success@upi", // ⚡ Test VPA for UPI success
//           },
//         },
//       });
...
//       if (result.paymentIntent.status === "succeeded") {
//         toast.success("✅ UPI Payment successful! Placing order...");
...
//       }
//     } catch (err) {
//       toast.error("UPI Payment failed: " + err.message);
//     }
//   };
...
//       onClick={handleUPI}
//       disabled={!stripe}
//       className="w-full bg-purple-600 text-white py-3 px-6 rounded-lg hover:bg-purple-700 transition duration-300 font-semibold shadow-lg"
//     >
...
// // ========================== NETBANKING CHECKOUT ==========================
// const NetBankingForm = ({ product, formDataup, setOrderSuccess }) => {
//   const stripe = useStripe();
...
//       toast.info("Redirecting to NetBanking gateway...");
//     } catch (err) {
//       toast.error("NetBanking failed: " + err.message);
//     }
//   };
...
//       disabled={!stripe}
//       className="w-full bg-orange-600 text-white py-3 px-6 rounded-lg hover:bg-orange-700 transition duration-300 font-semibold shadow-lg"
//     >
//       Pay with NetBanking
//     </button>
//   );
...
//                   {[
//                     { id: "card", label: "Credit / Debit Card" },
//                     { id: "upi", label: "PhonePe / Google Pay / Paytm (UPI)" },
